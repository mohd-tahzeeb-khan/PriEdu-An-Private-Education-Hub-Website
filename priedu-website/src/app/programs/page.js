...
import First from '../../../public/images/seventh.png'
import Second from '../../../public/images/11.png'
const page = () => {
  return (
    <>
    <div className='main-div relative mx-auto flex flex-col gap-7 py-10 px-10 bg-[#FEF9F2] justify-center items-center'>
